...
* **Objective:** Verify that user passwords are NOT stored in cleartext (plain text) within the database, complying with standard cryptographic security practices.
