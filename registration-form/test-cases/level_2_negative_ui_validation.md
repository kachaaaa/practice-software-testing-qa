...
* **Expected Result (UI):**
 ...
 1. The form is not submitted (the page does not reload, there is no redirect).
...
* **Steps:**
 ...
 1. In the Email field, enter `test.com`.
 2. Fill in the remaining fields with valid data from Item 1.1.
 3. Click "Register."

* **Expected Result:**
 
 1. The form is blocked from submission.
...
* **Compliance Check:**
  ...
  * Length: 9 characters (condition >= 8 met)
...
* **Steps:**
 ...
 1. Fill in all other required fields (Email, Name, etc.) with valid data.
...
* **Requirements Coverage Analysis:**
  ...
  * Length: 11 characters (condition >= 8 met)
...
* **Steps:**
 ...
 1. Fill in all other required fields with valid data.
...
* **Test Scenarios:**
 ...
 1. **No number:** Enter `P@ssword` $\rightarrow$ A corresponding password violation message is displayed.
...
* **Test Scenarios:**
 ...
 1. **Format error (dots instead of hyphens):** Enter `10.25.1995` or `1995.10.25`
