...
* **Expected Result (UI):**
  ...
  3. On the Cart page, the selected item is displayed with the correct Name ("Pliers"), Price, Quantity (1), and the Total price perfectly matches the product price.
